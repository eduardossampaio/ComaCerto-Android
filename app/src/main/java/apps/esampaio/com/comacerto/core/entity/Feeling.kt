...
enum class Feeling {
    ...
    Frustration(R.string.feeling_frustration,R.drawable.feeling_frustration_flat),
    ...
    Boredom(R.string.feeling_boredom,R.drawable.feeling_boredom_flat),
    Sad(R.string.feeling_sad,R.drawable.feeling_sad_flat);
